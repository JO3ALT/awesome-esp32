...
- [esp32-gameos](https://github.com/MikeWilson/infinite-golf) - A handheld gaming OS for the Waveshare ESP32-S3-Touch-AMOLED-1.8: launcher plus six fully procedural games at 60 fps, no engine, no asset files. ([demo](https://x.com/mk_wlsn/status/2089740913195274284)) `Waveshare ESP32-S3-Touch-AMOLED-1.8`
